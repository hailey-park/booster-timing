...
age_18_49 <- read.csv("calibration-results/sensitivity/100-seroprevalence/adj-calibration-1mil-18-49 years-lower.csv")[,-1]
age_50_64 <-  read.csv("calibration-results/sensitivity/100-seroprevalence/adj-calibration-1mil-50-64 years-lower.csv")[,-1]
age_65_74 <-  read.csv("calibration-results/sensitivity/100-seroprevalence/adj-calibration-1mil-65-74 years-lower.csv")[,-1]
age_75_plus <-  read.csv("calibration-results/sensitivity/100-seroprevalence/adj-calibration-1mil-75+ years-lower.csv")[,-1]
...
noBoosterSimulation <- function(df){
  ...
  write.csv(input, paste0("simulation-results/sensitivity-new/100-seroprevalence/noBooster-", age_info, "-lower.csv"))
}
...
oneBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity-new/100-seroprevalence/1Booster-", age_info, "-lower.csv")) ####CHANGE HERE
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity-new/100-seroprevalence/annualBooster-", age_info, "-lower.csv")) ####CHANGE HERE
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity-new/100-seroprevalence/biannualBooster-", age_info, "-lower.csv")) ####CHANGE HERE
}
