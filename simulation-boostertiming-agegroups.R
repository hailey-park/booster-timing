...
nonsevere_infection_multipliers <- data.frame(age_group = c("18-49 years", "50-64 years", "65-74 years", "75+ years"),
                                              multiplier = c(100, 39.5, 10.9, 4.3) * 2)
...
age_18_49 <- read.csv("calibration-results/main/adj-calibration-1mil-18-49 years-lower.csv")[,-1]
age_50_64 <-  read.csv("calibration-results/main/adj-calibration-1mil-50-64 years-lower.csv")[,-1]
age_65_74 <-  read.csv("calibration-results/main/adj-calibration-1mil-65-74 years-lower.csv")[,-1]
age_75_plus <-  read.csv("calibration-results/main/adj-calibration-1mil-75+ years-lower.csv")[,-1]
...
noBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/high-subclinical-infection/noBooster-", age_info, "-lower.csv"))
}
...
oneBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/high-subclinical-infection/1Booster-", age_info, "-lower.csv")) ####CHANGE HERE
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/high-subclinical-infection/annualBooster-", age_info, "-lower.csv")) ####CHANGE HERE
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/high-subclinical-infection/biannualBooster-", age_info, "-lower.csv")) ####CHANGE HERE
}
