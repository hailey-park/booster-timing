...
average_nonsevere_incidence <- data.frame(age_group = c("0-17 years","18-49 years", "50-64 years", "65-74 years", "75+ years"),
                                          ...
                                          pe_avg = c(0.3039797, 0.3512101, 0.3438841, 0.3448746 , 0.3447824)) %>%
  mutate(pe_minus_1 = 1 - pe_avg,
         pe_adj = (1 - 0.3448746)/pe_minus_1,
...
entire_pop <-  read.csv("calibration-results/entire_population_calibration_nonsevere1.5x_lower.csv")[,-1] 
