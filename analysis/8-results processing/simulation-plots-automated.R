...
severe_95ui <- function(df){
  ...
  mean <- read.csv(paste0("results/simulation-results/main/immunocompetent/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_1 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-lower/sero-upper/case-upper/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_2 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-lower/sero-upper/case-mean/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_3 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-lower/sero-upper/case-lower/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_4 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-lower/sero-lower/case-upper/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_5 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-lower/sero-lower/case-mean/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_6 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-lower/sero-lower/case-lower/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_7 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-lower/sero-mean/case-upper/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_8 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-lower/sero-mean/case-mean/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_9 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-lower/sero-mean/case-lower/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_10 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-mean/sero-upper/case-upper/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_11 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-mean/sero-upper/case-mean/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_12 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-mean/sero-upper/case-lower/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_13 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-mean/sero-lower/case-upper/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_14<- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-mean/sero-lower/case-mean/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_15<- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-mean/sero-lower/case-lower/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_16 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-mean/sero-mean/case-upper/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_18 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-mean/sero-mean/case-lower/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_19<- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-upper/sero-upper/case-upper/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_20 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-upper/sero-upper/case-mean/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_21 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-upper/sero-upper/case-lower/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_22 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-upper/sero-lower/case-upper/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_23 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-upper/sero-lower/case-mean/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_24 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-upper/sero-lower/case-lower/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_25 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-upper/sero-mean/case-upper/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_26 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-upper/sero-mean/case-mean/", intervention,"-", age_group, "-average.csv"))[,-1]
  ui_27 <- read.csv(paste0("results/simulation-results/main/immunocompetent/waning-upper/sero-mean/case-lower/", intervention,"-", age_group, "-average.csv"))[,-1]
