...
average_10_sims_no <- function(df){
  ...
  write.csv(sim_df, paste0("results/simulation-results/variantAnalysis/S3/ver1/", immune_status, "/waning-", waning, "/sero-", sero, "/case-", case, "/noBooster-", age_info, "-average.csv"))
}
...
average_10_sims_one <- function(df){
  ...
  write.csv(sim_df, paste0("results/simulation-results/variantAnalysis/S3/ver1/", immune_status, "/waning-", waning, "/sero-", sero, "/case-", case, "/1Booster-", age_info, "-average.csv"))
}
...
average_10_sims_annual <- function(df){
  ...
  write.csv(sim_df, paste0("results/simulation-results/variantAnalysis/S3/ver1/", immune_status, "/waning-", waning, "/sero-", sero, "/case-", case, "/annualBooster-", age_info, "-average.csv"))
...
average_10_sims_biannual <- function(df){
  ...
  write.csv(sim_df, paste0("results/simulation-results/variantAnalysis/S3/ver1/", immune_status, "/waning-", waning, "/sero-", sero, "/case-", case, "/biannualBooster-", age_info, "-average.csv"))
  ...
  for (waning in c("upper", "mean", "lower")){
    ...
    for (sero in c("upper", "mean", "lower")){
      ...
      for (case in c("upper", "mean", "lower")){
        ...
        source(here::here(paste0("analysis/5-variant scenario analysis/S3/immune evasion ver1/simulation-data-inputs-95ui-", immune_status, ".R")))
        source(here::here(paste0("analysis/5-variant scenario analysis/S3/intervention-functions-variantAnalysis-S3-", immune_status, ".R")))
