...
var1_severe_waning_data <- read.csv("results/waning-predictions/variant-waning/S3-immune-escape-ver2/novel-var1/severe_waning_predictions_monthly.csv")[,-1]
var1_nonsevere_waning_data <- read.csv("results/waning-predictions/variant-waning/S3-immune-escape-ver2/novel-var1/nonsevere_waning_predictions_monthly.csv")[,-1]

var2_severe_waning_data <- read.csv("results/waning-predictions/variant-waning/S3-immune-escape-ver2/novel-var2/severe_waning_predictions_monthly.csv")[,-1]
var2_nonsevere_waning_data <- read.csv("results/waning-predictions/variant-waning/S3-immune-escape-ver2/novel-var2/nonsevere_waning_predictions_monthly.csv")[,-1]
