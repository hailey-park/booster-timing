...
new_severe_waning_data <- read.csv("results/waning-predictions/variant-waning/immune-escape-ver1/severe_waning_predictions_monthly_immunoMild.csv")[,-1]
new_nonsevere_waning_data <- read.csv("results/waning-predictions/variant-waning/immune-escape-ver1/nonsevere_waning_predictions_monthly_immunoMild.csv")[,-1]
