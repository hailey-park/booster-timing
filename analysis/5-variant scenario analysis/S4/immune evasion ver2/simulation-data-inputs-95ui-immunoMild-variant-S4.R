...
new_vax_severe_waning_data <- read.csv("results/waning-predictions/variant-waning/S4-immune-escape-ver2/severe_waning_predictions_monthly_immunoMild.csv")[,-1]
new_vax_nonsevere_waning_data <- read.csv("results/waning-predictions/variant-waning/S4-immune-escape-ver2/nonsevere_waning_predictions_monthly_immunoMild.csv")[,-1]
