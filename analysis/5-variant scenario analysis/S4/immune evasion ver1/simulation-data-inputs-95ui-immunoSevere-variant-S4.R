...
var1_severe_waning_data <- read.csv("results/waning-predictions/variant-waning/S4-immune-escape-ver1/novel-var1/severe_waning_predictions_monthly_immunoSevere.csv")[,-1]
var1_nonsevere_waning_data <- read.csv("results/waning-predictions/variant-waning/S4-immune-escape-ver1/novel-var1/nonsevere_waning_predictions_monthly_immunoSevere.csv")[,-1]

var2_severe_waning_data <- read.csv("results/waning-predictions/variant-waning/S4-immune-escape-ver1/novel-var2/severe_waning_predictions_monthly_immunoSevere.csv")[,-1]
var2_nonsevere_waning_data <- read.csv("results/waning-predictions/variant-waning/S4-immune-escape-ver1/novel-var2/nonsevere_waning_predictions_monthly_immunoSevere.csv")[,-1]
...
waning_data_clean <- setDT(merge(merge(merge(merge(merge(var2_severe_waning, old_severe_waning, by = c("age_group", "prior_inf", "months"), all = TRUE),
...
age_18_49 <- read.csv(paste0("results/calibration/main/immunoSevere/waning-", waning, "/sero-", sero, "/1mil-18-49 years-monthly.csv"))[,-1] 
age_50_64 <-  read.csv(paste0("results/calibration/main/immunoSevere/waning-", waning, "/sero-", sero, "/1mil-50-64 years-monthly.csv"))[,-1]
age_65_74 <-  read.csv(paste0("results/calibration/main/immunoSevere/waning-", waning, "/sero-", sero, "/1mil-65-74 years-monthly.csv"))[,-1]
age_75_plus <-  read.csv(paste0("results/calibration/main/immunoSevere/waning-", waning, "/sero-", sero, "/1mil-75+ years-monthly.csv"))[,-1] 
############################################################################################
#clean age matrices
