...
waning_data <- read.csv("data/raw-data/nonsevere waning data absolute 090623 mean.csv") 
weights <- read.csv("data/raw-data/nonsevere waning data absolute 090623 weights.csv") 
waning_data_95ui <- read.csv("data/raw-data/nonsevere waning data absolute 090623 95ui.csv")
...
preds_monthly <- predict(nonsevere_model, newdata = prediction_data_monthly, allow.new.levels = TRUE)
...
#Write to csv
write.csv(prediction_data_immunocompetent, "results/waning-predictions/main/nonsevere_waning_predictions_monthly.csv")
write.csv(prediction_data_immuno_mild, "results/waning-predictions/main/nonsevere_waning_predictions_monthly_immunoMild.csv")
write.csv(prediction_data_immuno_severe, "results/waning-predictions/main/nonsevere_waning_predictions_monthly_immunoSevere.csv")
...
write.csv(prediction_data_immunocompetent_opt_ve, "results/waning-predictions/optimistic-ve/nonsevere_waning_predictions_monthly.csv")
write.csv(prediction_data_immuno_mild_opt_ve, "results/waning-predictions/optimistic-ve/nonsevere_waning_predictions_monthly_immunoMild.csv")
write.csv(prediction_data_immuno_severe_opt_ve, "results/waning-predictions/optimistic-ve/nonsevere_waning_predictions_monthly_immunoSevere.csv")
...
write.csv(prediction_data_immunocompetent_pess_ve, "results/waning-predictions/pessimistic-ve/nonsevere_waning_predictions_monthly.csv")
write.csv(prediction_data_immuno_mild_pess_ve, "results/waning-predictions/pessimistic-ve/nonsevere_waning_predictions_monthly_immunoMild.csv")
write.csv(prediction_data_immuno_severe_pess_ve, "results/waning-predictions/pessimistic-ve/nonsevere_waning_predictions_monthly_immunoSevere.csv")
...
write.csv(prediction_data_immuno_mild_opt_wan, "results/waning-predictions/optimistic-waning/nonsevere_waning_predictions_monthly_immunoMild.csv")
write.csv(prediction_data_immuno_severe_opt_wan, "results/waning-predictions/optimistic-waning/nonsevere_waning_predictions_monthly_immunoSevere.csv")
...
write.csv(prediction_data_immunocompetent_pess_wan, "results/waning-predictions/pessimistic-waning/nonsevere_waning_predictions_monthly.csv")
write.csv(prediction_data_immuno_mild_pess_wan, "results/waning-predictions/pessimistic-waning/nonsevere_waning_predictions_monthly_immunoMild.csv")
write.csv(prediction_data_immuno_severe_pess_wan, "results/waning-predictions/pessimistic-waning/nonsevere_waning_predictions_monthly_immunoSevere.csv")
