...
save_results <- function(df){
  ...
  write.csv(df, paste0("results/calibration/main/immunoSevere/waning-", waning, "/sero-", sero, "/1mil-",age_group,"-monthly.csv")) 
...
for (waning in c("upper", "mean", "lower")) {
  dir.create(paste0("results/calibration/main/immunoSevere/waning-", waning))
  
  for (sero in c("upper", "mean", "lower")) {
    dir.create(paste0("results/calibration/main/immunoSevere/waning-", waning, "/sero-", sero))
  }
}
