...
noBoosterSim_parallel <- function(df){
  ...
  write.csv(sim_df, paste0("results/simulation-results/sensitivity/lower-vax-eff/", immune_status, "/waning-", waning, "/sero-", sero, "/case-", case, "/noBooster-", age_info, "-average.csv"))
}
...
oneBoosterSim_parallel <- function(df){
  ...
  write.csv(sim_df, paste0("results/simulation-results/sensitivity/lower-vax-eff/", immune_status, "/waning-", waning, "/sero-", sero, "/case-", case, "/1Booster-", age_info, "-average.csv"))
}
...
annualBoosterSim_parallel <- function(df){
  ...
  write.csv(sim_df, paste0("results/simulation-results/sensitivity/lower-vax-eff/", immune_status, "/waning-", waning, "/sero-", sero, "/case-", case, "/annualBooster-", age_info, "-average.csv"))
}
...
biannualBoosterSim_parallel <- function(df){
  ...
  write.csv(sim_df, paste0("results/simulation-results/sensitivity/lower-vax-eff/", immune_status, "/waning-", waning, "/sero-", sero, "/case-", case, "/biannualBooster-", age_info, "-average.csv"))
}
...
for (waning in c("upper", "mean", "lower")){
  ...
  for (sero in c("upper", "mean", "lower")){
    ...
    for (case in c("upper", "mean", "lower")){
      ...
      source(here::here(paste0("analysis/6-sensitivity analysis/lower-vax-eff/simulation-data-inputs-95ui-", immune_status, ".R")))
      source(here::here(paste0("analysis/6-sensitivity analysis/lower-vax-eff/intervention-functions-", immune_status, "-lowerVaccEff.R")))
