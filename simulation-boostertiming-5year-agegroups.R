...
noBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:67)]), paste0("simulation-results/sensitivity/5-year-sim/noBooster-", age_info, "-mean.csv"))
}
...
oneBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:67)]), paste0("simulation-results/sensitivity/5-year-sim/1Booster-", age_info, "-mean.csv")) ####CHANGE HERE
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:67)]), paste0("simulation-results/sensitivity/5-year-sim/annualBooster-", age_info, "-mean.csv")) ####CHANGE HERE
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:67)]), paste0("simulation-results/sensitivity/5-year-sim/biannualBooster-", age_info, "-mean.csv")) ####CHANGE HERE
}
