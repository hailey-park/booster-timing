...
#Load data
waning_data_clean <- read.csv("data/pessimistic-ve/ve_waning_predictions_mean_immunocompromised.csv")[,-1] 
waning_data_clean_95UI <- read.csv("data/pessimistic-ve/ve_waning_predictions_95UI_immunocompromised.csv")[,-1]
...
immunocompromised <- read.csv("calibration-results/sensitivity/pessimistic-ve/adj-calibration-1mil-immunocompromised-mean.csv")[,-1]
...
noBoosterSimulation <- function(df){
  ...
  write.csv(input, "simulation-results/sensitivity-new/pessimistic-ve/noBooster-immuno-mean.csv")
}
...
oneBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), "simulation-results/sensitivity-new/pessimistic-ve/1Booster-immuno-mean.csv")
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity-new/pessimistic-ve/annualBooster-immuno-mean.csv"))
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity-new/pessimistic-ve/biannualBooster-immuno-mean.csv"))
}
