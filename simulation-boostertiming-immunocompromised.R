...
nonsevere_infection_multipliers <- data.frame(age_group = c("immunocompromised"),
                                              multiplier = c(16.857)*2)

#Read in matrices for each age group
immunocompromised <- read.csv("calibration-results/main/adj-calibration-1mil-immunocompromised-upper.csv")[,-1]
...
noBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), "simulation-results/sensitivity/high-subclinical-infection/noBooster-immuno-upper.csv")
}
...
oneBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), "simulation-results/sensitivity/high-subclinical-infection/1Booster-immuno-upper.csv")
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/high-subclinical-infection/annualBooster-immuno-upper.csv"))
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/high-subclinical-infection/biannualBooster-immuno-upper.csv"))
}
