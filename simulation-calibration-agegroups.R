...
waning_data_mean <- read.csv("data/no-waning/ve_waning_predictions_mean.csv")[,-1] ##CHANGE HERE 
waning_data_95UI <- read.csv("data/no-waning/ve_waning_predictions_95UI.csv")[,-1]  #CHANGE HERE 
...
#folder options: optimistic_ve or pessimistic_ve
#estimate options: mean, lower, upper

save_results <- function(df){
  age_group <- (df$age_group)[1]
  write.csv(df, paste0("calibration-results/sensitivity/no-waning/adj-calibration-1mil-",age_group,"-lower.csv")) 
