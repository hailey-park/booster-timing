...
noBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/lower-ve-subsequent-shot/noBooster-", age_info, "-mean.csv"))
}
...
oneBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/lower-ve-subsequent-shot/1Booster-", age_info, "-mean.csv")) ####CHANGE HERE
}
...
annualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/lower-ve-subsequent-shot/annualBooster-", age_info, "-mean.csv")) ####CHANGE HERE
}
...
biannualBoosterSimulation <- function(df){
  ...
  write.csv(colSums(input[, (7:31)]), paste0("simulation-results/sensitivity/lower-ve-subsequent-shot/biannualBooster-", age_info, "-mean.csv")) ####CHANGE HERE
}
